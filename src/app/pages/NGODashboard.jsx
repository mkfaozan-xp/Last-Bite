...
import { Package, Check, X, Phone, Mail, MapPin, Clock, Bell, Leaf, Droplets, Wind, TreePine } from 'lucide-react';
    ...
    >
      <div className="space-y-4">
        ...
        {type === 'accepted' && donation.status === 'accepted' && (
          <div className="flex items-center justify-between bg-green-100 dark:bg-green-950/30 rounded-lg p-4">
